...
! function(e, t) {
    ...
    var o = {
        ...
        on: function() {
            ...
            for (var p, u = n.split(" "), h = 0; h < this.length; h += 1) {
                var v = i[h];
                if (o)
                    for (p = 0; p < u.length; p += 1) v.dom7LiveListeners || (v.dom7LiveListeners = []), v.dom7LiveListeners.push({
                        type: n,
                        listener: l,
                        proxyListener: t
                    }), v.addEventListener(u[p], t, d);
                else
                    for (p = 0; p < u.length; p += 1) v.dom7Listeners || (v.dom7Listeners = []), v.dom7Listeners.push({
                        type: n,
                        listener: l,
                        proxyListener: a
                ...
                for (var c = 0; c < this.length; c += 1) {
                    ...
                    if (s) {
                        if (p.dom7LiveListeners)
                            for (var u = 0; u < p.dom7LiveListeners.length; u += 1) r ? p.dom7LiveListeners[u].listener === r && p.removeEventListener(l[d], p.dom7LiveListeners[u].proxyListener, n) : p.dom7LiveListeners[u].type === l[d] && p.removeEventListener(l[d], p.dom7LiveListeners[u].proxyListener, n)
                    } else if (p.dom7Listeners)
                        for (var h = 0; h < p.dom7Listeners.length; h += 1) r ? p.dom7Listeners[h].listener === r && p.removeEventListener(l[d], p.dom7Listeners[h].proxyListener, n) : p.dom7Listeners[h].type === l[d] && p.removeEventListener(l[d], p.dom7Listeners[h].proxyListener, n)
                }
            return this
        },
        trigger: function() {
    ...
    var u = {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== i) {
                    ...
                    for (var E, S = t.slidesPerColumn, C = T / S, M = C - (t.slidesPerColumn * C - o), z = 0; z < o; z += 1) {
                        ...
                        "none" !== P.css("display") && ("auto" === t.slidesPerView ? (E = e.isHorizontal() ? P.outerWidth(!0) : P.outerHeight(!0), t.roundLengths && (E = Math.floor(E))) : (E = (i - (t.slidesPerView - 1) * b) / t.slidesPerView, t.roundLengths && (E = Math.floor(E)), n[z] && (e.isHorizontal() ? n[z].style.width = E + "px" : n[z].style.height = E + "px")), n[z] && (n[z].swiperSlideSize = E), u.push(E), t.centeredSlides ? (w = w + E / 2 + y / 2 + b, 0 === y && 0 !== z && (w = w - i / 2 - b), 0 === z && (w = w - i / 2 - b), Math.abs(w) < .001 && (w = 0), x % t.slidesPerGroup == 0 && c.push(w), p.push(w)) : (x % t.slidesPerGroup == 0 && c.push(w), p.push(w), w = w + E + b), e.virtualSize += E + b, y = E, x += 1)
                    }
                    ...
                    if (s && r && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
                        ...
                        L = [];
                        for (var D = 0; D < c.length; D += 1) c[D] < e.virtualSize + c[0] && L.push(c[D]);
                        c = L
                    }
                    if (!t.centeredSlides) {
                        L = [];
                        for (var O = 0; O < c.length; O += 1) c[O] <= e.virtualSize - i && L.push(c[O]);
                        c = L, Math.floor(e.virtualSize - i) - Math.floor(c[c.length - 1]) > 1 && c.push(e.virtualSize - i)
                    }
                    0 === c.length && (c = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? s ? n.css({
                        marginLeft: b + "px"
                    }) : n.css({
                        marginRight: b + "px"
                    }) : n.css({
                        ...
                        slidesGrid: p,
                        slidesSizesGrid: u
                    }), o !== f && e.emit("slidesLengthChange"), c.length !== m && e.emit("snapGridLengthChange"), p.length !== g && e.emit("slidesGridLengthChange"), (t.watchSlidesProgress || t.watchSlidesVisibility) && e.updateSlidesOffset()
                }
            },
                ...
                if (0 !== i.length) {
                    ...
                    for (var n = 0; n < i.length; n += 1) {
                        ...
                        if (a.watchSlidesVisibility) {
                            ...
                            (d >= 0 && d < t.size || c > 0 && c <= t.size || d <= 0 && c >= t.size) && i.eq(n).addClass(a.slideVisibleClass)
                        }
                        o.progress = s ? -l : l
                    }
                }
            ...
            updateActiveIndex: function(e) {
                var t, a = this,
                    ...
                    c = e;
                if (void 0 === c) {
                    for (var p = 0; p < s.length; p += 1) void 0 !== s[p + 1] ? i >= s[p] && i < s[p + 1] - (s[p + 1] - s[p]) / 2 ? c = p : i >= s[p] && i < s[p + 1] && (c = p + 1) : i >= s[p] && (c = p);
                    n.normalizeSlideIndex && (c < 0 || void 0 === c) && (c = 0)
                }
                if ((t = Math.floor(c / n.slidesPerGroup)) >= r.length && (t = r.length - 1), c !== o) {
        ...
        x = function(t) {
            ...
            if (n.originalEvent && (n = n.originalEvent), i.isTouchEvent = "touchstart" === n.type, i.isTouchEvent || !("which" in n) || 3 !== n.which)
                ...
                var o = r.currentX,
                    d = r.currentY;
                if (!(y.ios && s.iOSEdgeSwipeDetection && o <= s.iOSEdgeSwipeThreshold)) {
                    if (l.extend(i, {
                            isTouched: !0,
                            isMoved: !1,
                        ...
                        var c = !0;
                        e(n.target).is(i.formElements) && (c = !1), document.activeElement && e(document.activeElement).is(i.formElements) && document.activeElement.blur(), c && n.preventDefault()
                    }
                    a.emit("touchStart", n)
                }
            }
            ...
            if (o.originalEvent && (o = o.originalEvent), !i.isTouchEvent || "mousemove" !== o.type) {
                ...
                if (i.allowTouchCallbacks && a.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                    if (r.currentX = "touchmove" === o.type ? o.targetTouches[0].pageX : o.pageX, r.currentY = "touchmove" === o.type ? o.targetTouches[0].pageY : o.pageY, void 0 === i.isScrolling) {
                        var p;
                        a.isHorizontal() && r.currentY === r.startY || a.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : (p = 180 * Math.atan2(Math.abs(r.currentY - r.startY), Math.abs(r.currentX - r.startX)) / Math.PI, i.isScrolling = a.isHorizontal() ? p > s.touchAngle : 90 - p > s.touchAngle)
                    }
            ...
            events: {
                attachEvents: function() {
                    ...
                    if (f.ie) r.addEventListener(a.start, e.onTouchStart, !1), (d.touch ? r : document).addEventListener(a.move, e.onTouchMove, n), (d.touch ? r : document).addEventListener(a.end, e.onTouchEnd, !1);
                        ...
                        }(t.simulateTouch && !y.ios && !y.android || t.simulateTouch && !d.touch && y.ios) && (r.addEventListener("mousedown", e.onTouchStart, !1), document.addEventListener("mousemove", e.onTouchMove, n), document.addEventListener("mouseup", e.onTouchEnd, !1))
                ...
                detachEvents: function() {
                    ...
                    if (f.ie) r.removeEventListener(a.start, e.onTouchStart, !1), (d.touch ? r : document).removeEventListener(a.move, e.onTouchMove, n), (d.touch ? r : document).removeEventListener(a.end, e.onTouchEnd, !1);
                        ...
                        }(t.simulateTouch && !y.ios && !y.android || t.simulateTouch && !d.touch && y.ios) && (r.removeEventListener("mousedown", e.onTouchStart, !1), document.removeEventListener("mousemove", e.onTouchMove, n), document.removeEventListener("mouseup", e.onTouchEnd, !1))
                    ...
                    if (r && (!r || 0 !== Object.keys(r).length)) {
                        ...
                        if (n && e.currentBreakpoint !== n) {
                            ...
                            if (l.extend(e.params, o), l.extend(e, {
                                ...
                                var c = t - i;
                                e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(c + i, 0, !1)
                            }
                        }
                    }
                }
            ...
            classes: {
                addClasses: function() {
                    var e = this,
                        ...
                        s = e.$el,
                        n = [];
                    n.push(a.direction), a.freeMode && n.push("free-mode"), d.flexbox || n.push("no-flexbox"), a.autoHeight && n.push("autoheight"), i && n.push("rtl"), a.slidesPerColumn > 1 && n.push("multirow"), y.android && n.push("android"), y.ios && n.push("ios"), (r.navigator.pointerEnabled || r.navigator.msPointerEnabled) && n.push("wp8-" + a.direction), n.forEach(function(e) {
        ...
        k = function(t) {
            function a() {
                ...
                if (n = h[0]) {
                    ...
                    return l.extend(p, {
                        ...
                        rtl: "horizontal" === p.params.direction && ("rtl" === n.dir.toLowerCase() || "rtl" === h.css("direction")),
            ...
            return a.prototype.slidesPerViewDynamic = function() {
                ...
                if (t.centeredSlides) {
                    ...
                    for (var p = r + 1; p < a.length; p += 1) i[p] - i[r] < s && (n += 1);
                return n
        ...
        X = {
            update: function(e) {
                ...
                if (l.extend(a.virtual, {
                    ...
                    }), d === w && c === y && !e) return a.slidesGrid !== u && x !== v && a.slides.css(f, x + "px"), void a.updateProgress();
                ...
                if (e) a.$wrapperEl.find("." + a.params.slideClass).remove();
                    ...
                    for (var S = d; S <= c; S += 1)(S < w || S > y) && a.$wrapperEl.find("." + a.params.slideClass + '[data-swiper-slide-index="' + S + '"]').remove();
                for (var C = 0; C < p.length; C += 1) C >= w && C <= y && (void 0 === c || e ? E.push(C) : (C > c && E.push(C), C < d && T.push(C)));
                E.forEach(function(e) {
                ...
                if (a.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                    ...
                    if ("fraction" === a.type && (r.find("." + a.currentClass).text(i + 1), r.find("." + a.totalClass).text(n)), "progressbar" === a.type) {
                        var c = (i + 1) / n,
                            p = c,
                            u = 1;
                        t.isHorizontal() || (u = c, p = 1), r.find("." + a.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + p + ") scaleY(" + u + ")").transition(t.params.speed)
                    }
            ...
            setTranslate: function() {
                ...
                if (e.params.scrollbar.el && e.scrollbar.el) {
                    var t = e.scrollbar,
                        ...
                        c = s,
                        p = (r - s) * i;
                    a && e.isHorizontal() ? (p = -p) > 0 ? (c = s - p, p = 0) : -p + s > r && (c = r + p) : p < 0 ? (c = s + p, p = 0) : p + s > r && (c = r - p), e.isHorizontal() ? (d.transforms3d ? n.transform("translate3d(" + p + "px, 0, 0)") : n.transform("translateX(" + p + "px)"), n[0].style.width = c + "px") : (d.transforms3d ? n.transform("translate3d(0px, " + p + "px, 0)") : n.transform("translateY(" + p + "px)"), n[0].style.height = c + "px"), l.hide && (clearTimeout(e.scrollbar.timeout), o[0].style.opacity = 1, e.scrollbar.timeout = setTimeout(function() {
        ...
        K = {
            setTransform: function(t, a) {
                ...
                if (l || d ? (l = l || "0", d = d || "0") : i.isHorizontal() ? (l = o, d = "0") : (d = o, l = "0"), l = l.indexOf("%") >= 0 ? parseInt(l, 10) * a * n + "%" : l * a * n + "px", d = d.indexOf("%") >= 0 ? parseInt(d, 10) * a + "%" : d * a + "px", "undefined" != typeof pOpacity && null !== p) {
                    var u = p - (p - 1) * (1 - Math.abs(a));
                    r[0].style.opacity = u
                }
                if ("undefined" == typeof pScale || null === c) r.transform("translate3d(" + l + ", " + d + ", 0px)");
                else {
                    ...
                    !r.hasClass(s.elementClass) || r.hasClass(s.loadedClass) || r.hasClass(s.loadingClass) || (n = n.add(r[0])), 0 !== n.length && n.each(function(t, n) {
                        ...
                        i.loadImage(o[0], d || l, c, p, !1, function() {
                            if (void 0 !== i && null !== i && i && (!i || i.params)) {
                                if (l ? (o.css("background-image", 'url("' + l + '")'), o.removeAttr("data-background")) : (c && (o.attr("srcset", c), o.removeAttr("data-srcset")), p && (o.attr("sizes", p), o.removeAttr("data-sizes")), d && (o.attr("src", d), o.removeAttr("data-src"))), o.addClass(s.loadedClass).removeClass(s.loadingClass), r.find("." + s.preloaderClass).remove(), i.params.loop && a) {
            ...
            load: function() {
                ...
                if (n.loadPrevNext)
                    if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                        for (var d = n.loadPrevNextAmount, c = o, p = Math.min(r + c + Math.max(d, c), s.length), u = Math.max(r - Math.max(c, d), 0), h = r + o; h < p; h += 1) s[h] && t.lazy.loadImagesInSlide(h);
            ...
            setTranslate: function() {
                ...
                for (var v = 0; v < r.length; v += 1) {
                    ...
                    var y = Math.max(Math.min(m[0].progress, 1), -1),
                        ...
                        T = 0,
                        E = 0;
                    g % 4 == 0 ? (x = 4 * -w * d, E = 0) : (g - 1) % 4 == 0 ? (x = 0, E = 4 * -w * d) : (g - 2) % 4 == 0 ? (x = d + 4 * w * d, E = d) : (g - 3) % 4 == 0 && (x = -d, E = 3 * d + 4 * d * w), l && (x = -x), p || (T = x, x = 0);
                    var S = "rotateX(" + (p ? 0 : -b) + "deg) rotateY(" + (p ? b : 0) + "deg) translate3d(" + x + "px, " + T + "px, " + E + "px)";
                    if (y <= 1 && y > -1 && (h = 90 * g + 90 * y, l && (h = 90 * -g - 90 * y)), m.transform(S), c.slideShadows) {
                        ...
                        0 === C.length && (C = e('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), m.append(C)), 0 === M.length && (M = e('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), m.append(M)), C.length && (C[0].style.opacity = Math.max(-y, 0)), M.length && (M[0].style.opacity = Math.max(y, 0))
                    }
                }
                if (s.css({
                    ...
                    if (p) t.transform("translate3d(0px, " + (n / 2 + c.shadowOffset) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + c.shadowScale + ")");
                    else {
            ...
            setTranslate: function() {
                for (var t = this, a = t.slides, i = 0; i < a.length; i += 1) {
                    ...
                    if (t.isHorizontal() ? t.rtl && (n = -n) : (d = l, l = 0, o = -n, n = 0), s[0].style.zIndex = -Math.abs(Math.round(r)) + a.length, t.params.flipEffect.slideShadows) {
                        ...
                        0 === c.length && (c = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left" : "top") + '"></div>'), s.append(c)), 0 === p.length && (p = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(p)), c.length && (c[0].style.opacity = Math.max(-r, 0)), p.length && (p[0].style.opacity = Math.max(r, 0))
                    }
        ...
        me = {
            setTranslate: function() {
                for (var t = this, a = t.width, i = t.height, s = t.slides, r = t.$wrapperEl, n = t.slidesSizesGrid, o = t.params.coverflowEffect, l = t.isHorizontal(), d = t.translate, c = l ? a / 2 - d : i / 2 - d, p = l ? o.rotate : -o.rotate, u = o.depth, h = 0, v = s.length; h < v; h += 1) {
                    var m = s.eq(h),
                        g = n[h],
    ...
    return k.components = [$, I, L, D, H, A, N, B, R, F, q, U, Z, J, te, ie, re, oe, de, pe, he, fe, ge], k
});
