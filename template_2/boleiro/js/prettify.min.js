...
window.PR_SHOULD_USE_CONTINUATION = !0,
    function() {
        ...
        function t(t, n) {
            var r, a = {};
            ! function() {
                for (var e = t.concat(n), s = [], i = {}, o = 0, l = e.length; o < l; ++o) {
                    var c = e[o],
                        u = c[3];
                    if (u)
                        for (var d = u.length; --d >= 0;) a[u.charAt(d)] = c;
                    u = "" + (c = c[1]), i.hasOwnProperty(u) || (s.push(c), i[u] = q)
                }
                s.push(/[\S\s]/), r = function(e) {
                    function t(e) {
                    ...
                    function r(e) {
                        for (var r = e.substring(1, e.length - 1).match(/\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\S\s]|[^\\]/g), a = (e = [], []), s = "^" === r[0], i = s ? 1 : 0, o = r.length; i < o; ++i) {
                            var l, c = r[i];
                            if (/\\[bdsw]/i.test(c)) e.push(c);
                            else c = t(c), i + 2 < o && "-" === r[i + 1] ? (l = t(r[i + 2]), i += 2) : l = c, a.push([c, l]), l < 65 || c > 122 || (l < 65 || c > 90 || a.push([32 | Math.max(65, c), 32 | Math.min(l, 90)]), l < 97 || c > 122 || a.push([-33 & Math.max(97, c), -33 & Math.min(l, 122)]))
                        }
                        for (a.sort(function(e, t) {
                                return e[0] - t[0] || t[1] - e[1]
                            }), r = [], c = [NaN, NaN], i = 0; i < a.length; ++i) o = a[i], o[0] <= c[1] + 1 ? c[1] = Math.max(c[1], o[1]) : r.push(c = o);
            ...
            var i = n.length;
            return function t(o) {
                for (var l = o.d, c = [l, "pln"], u = 0, d = o.a.match(r) || [], p = {}, h = 0, f = d.length; h < f; ++h) {
                    var g, m = d[h],
                        y = p[m],
                        w = void 0;
                    if ("string" == typeof y) g = !1;
                        ...
                        if (v) w = m.match(v[1]), y = v[0];
                            ...
                            for (g = 0; g < i; ++g)
                                if (v = n[g], w = m.match(v[1])) {
                                    y = v[0];
                                    break
                                }
                            w || (y = "pln")
                        }!(g = y.length >= 5 && "lang-" === y.substring(0, 5)) || w && "string" == typeof w[1] || (g = !1, y = "src"), g || (p[m] = y)
                    }
                    if (v = u, u += m.length, g) {
                        g = w[1];
                        var b = m.indexOf(g),
                            S = b + g.length;
                        w[2] && (b = (S = m.length - w[2].length) - g.length), y = y.substring(5), e(l + v, m.substring(0, b), t, c), e(l + v + b, g, s(y, g), c), e(l + v + S, m.substring(S), t, c)
                    } else c.push(l + v, y)
                }
                o.e = c
            }
        ...
        function a(e, t) {
            for (var n = t.length; --n >= 0;) {
                var r = t[n];
                m.hasOwnProperty(r) ? window.console && console.warn("cannot override language handler %s", r) : m[r] = e
            }
        }

        function s(e, t) {
            return e && m.hasOwnProperty(e) || (e = /^\s*</.test(t) ? "default-markup" : "default-code"), m[e]
        }
        ...
        function i(e) {
            ...
            try {
                var n = (c = function(e) {
                    ...
                    return function e(t) {
                        switch (t.nodeType) {
                            ...
                            case 3:
                            case 4:
                                (l = t.nodeValue).length && (l = o ? l.replace(/\r\n?/g, "\n") : l.replace(/[\t\n\r ]+/g, " "), r[i] = l, s[i << 1] = a, a += l.length, s[i++ << 1 | 1] = t)
                        }
                    }(e), {
                        a: r.join("").replace(/\n$/, ""),
                        c: s
                ...
                var r, a, i = /\bMSIE\b/.test(navigator.userAgent),
                    o = (t = /\n/g, e.a),
                    l = o.length,
                    c = 0,
                    u = e.c,
                ...
                for (h = r, a = r = 0; a < h;) {
                    for (var f = p[a], g = p[a + 1], m = a + 2; m + 2 <= h && p[m + 1] === g;) m += 2;
                    p[r++] = f, p[r++] = g, a = m
                }
                for (p.length = r; n < d;) {
                    var y, w = u[n + 2] || l,
                        v = p[e + 2] || l,
                        b = (m = Math.min(w, v), u[n + 1]);
                    if (1 !== b.nodeType && (y = o.substring(c, m))) {
                        i && (y = y.replace(t, "\r")), b.nodeValue = y;
                        var S = b.ownerDocument,
                            x = S.createElement("SPAN");
                        x.className = p[e + 1];
                        var N = b.parentNode;
                        N.replaceChild(x, b), x.appendChild(b), c < w && (u[n + 1] = b = S.createTextNode(o.substring(m, w)), N.insertBefore(b, x.nextSibling))
                    }(c = m) >= w && (n += 2), c >= v && (e += 2)
                }
            } catch (e) {
        ...
        var o, l, c = [o = [
            ...
            u = [o, "abstract,boolean,byte,extends,final,finally,implements,import,instanceof,null,native,package,strictfp,super,synchronized,throws,transient"],
            ...
            p = [l, "and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"],
            h = [l, "alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],
            f = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)/,
            g = /\S/,
            m = {};
        a(n({
            keywords: [c, d, o = [o, "debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"], "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END" + p, h, l = [l, "case,done,elif,esac,eval,fi,function,in,local,set,then,until"]],
            hashComments: !0,
            cStyleComments: !0,
            multiLineStrings: !0,
            regexLiterals: !0
            ...
            ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]
        ]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]), a(t([
            ["pln", /^\s+/, q, " \t\r\n"],
            ["atv", /^(?:"[^"]*"?|'[^']*'?)/, q, "\"'"]
        ], [
            ["tag", /^^<\/?[a-z](?:[\w-.:]*\w)?|\/?>$/i],
            ...
            return a.innerHTML = e, n && r(a, n), i({
                g: t,
                i: n,
                h: a
            }), a.innerHTML
        }, window.prettyPrint = function(e) {
            for (var t = [document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document.getElementsByTagName("xmp")], n = [], a = 0; a < t.length; ++a)
                for (var s = 0, o = t[a].length; s < o; ++s) n.push(t[a][s]);
            t = q;
            var l = Date;
            l.now || (l = {
                now: function() {
            ...
            var c = 0,
                u = /\blang(?:uage)?-([\w.]+)(?!\S)/;
            ! function t() {
                for (var a = window.PR_SHOULD_USE_CONTINUATION ? l.now() + 250 : 1 / 0; c < n.length && l.now() < a; c++) {
                    var s = n[c];
                    if ((o = s.className).indexOf("prettyprint") >= 0) {
                        var o, d, p;
                        if (p = !(o = o.match(u))) {
                            for (var h = void 0, f = (p = s).firstChild; f; f = f.nextSibling) {
                                var m = f.nodeType;
                                h = 1 === m ? h ? p : f : 3 === m && g.test(f.nodeValue) ? p : h
                            }
                            p = (d = h === p ? void 0 : h) && "CODE" === d.tagName
                        }
                        for (p && (o = d.className.match(u)), o && (o = o[1]), p = !1, h = s.parentNode; h; h = h.parentNode)
                            if (("pre" === h.tagName || "code" === h.tagName || "xmp" === h.tagName) && h.className && h.className.indexOf("prettyprint") >= 0) {
                                p = !0;
                                break
                            }
                        p || ((p = !!(p = s.className.match(/\blinenums\b(?::(\d+))?/)) && (!p[1] || !p[1].length || +p[1])) && r(s, p), i({
                            g: o,
                            h: s,
                            i: p
                        }))
